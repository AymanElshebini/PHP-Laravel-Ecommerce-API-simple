        ...
        <div class="row form-body">
            <div class="col-md-6">
             ...
             <div class="col-md-6">
               ...
               <small class="text-white bg-danger p-1 rounded massageerror" v-if="errors.name">{{errors.meta_title[0]}}</small>
             ...
             <div class="col-md-6">
                ...
                <small class="text-white bg-danger p-1 rounded massageerror" v-if="errors.name">{{errors.meta_keywords[0]}}</small>
                </div>
                <div class="col-md-6">
                ...
                <small class="text-white bg-danger p-1 rounded massageerror" v-if="errors.name">{{errors.meta_description[0]}}</small>
                    </div>
          ...
          AddNew()
           {
            ...
            axios.post('api/AddCmstag', formData)
                .then((response) => {
                    // console.log(res);
